...
def camera_callback(msg):
    ...
    x1_centro = int(width / 2 - 10)
    x2_centro = int(width / 2 + 10)
    y1_centro = int(height / 2 - 250)
    y2_centro = int(height/ 2 - 225)
    ...
    print(color_promedio_rgb_centro.mean())
    
    if(color_promedio_rgb_centro.mean() > 120):
        instruction = "stop"
    else:
        instruction = "forward"
